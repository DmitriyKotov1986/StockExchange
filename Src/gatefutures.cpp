...
#include "StockExchange/gateklinefutures.h"
...
/// class GateFutures
///
GateFutures::GateFutures(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void GateFutures::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void GateFutures::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
