...
#include "StockExchange/htxkline.h"
...
/// class Htx
///
Htx::Htx(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void Htx::errorOccurredHTTP(QNetworkReply::NetworkError code, quint64 serverCode, const QString &msg, quint64 id, const QByteArray& answer)
{
    Q_UNUSED(code);
    Q_UNUSED(serverCode);
...
void Htx::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Htx::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
...
void Htx::makeKLines(const TradingCatCommon::PKLinesIDList klinesIdList)
{
