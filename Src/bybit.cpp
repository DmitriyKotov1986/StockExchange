...
#include "StockExchange/bybitkline.h"
...
/// class Bybit
///
Bybit::Bybit(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void Bybit::errorOccurredHTTP(QNetworkReply::NetworkError code, quint64 serverCode, const QString &msg, quint64 id, const QByteArray& answer)
{
    Q_UNUSED(code);
    Q_UNUSED(serverCode);
...
void Bybit::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Bybit::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
...
void Bybit::makeKLines(const TradingCatCommon::PKLinesIDList klinesIdList)
{
