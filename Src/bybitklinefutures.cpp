...
QString BybitKLineFutures::KLineTypeToString(TradingCatCommon::KLineType type)
{
    switch (type)
    {
...
BybitKLineFutures::BybitKLineFutures(const TradingCatCommon::KLineID &id, const QDateTime& lastClose, QObject *parent /* = nullptr */)
    : IKLine(id, parent)
...
void BybitKLineFutures::sendGetKline()
{
...
PKLinesList BybitKLineFutures::parseKLine(const QByteArray &answer)
{
...
void BybitKLineFutures::getAnswerHTTP(const QByteArray &answer, quint64 id)
{
...
void BybitKLineFutures::errorOccurredHTTP(QNetworkReply::NetworkError code, quint64 serverCode, const QString &msg, quint64 id, const QByteArray& answer)
{
    Q_UNUSED(code);
...
void BybitKLineFutures::sendLogMsgHTTP(Common::TDBLoger::MSG_CODE category, const QString &msg, quint64 id)
{
    Q_UNUSED(id);
