...
/// class Mexc
///
Mexc::Mexc(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void Mexc::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Mexc::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
