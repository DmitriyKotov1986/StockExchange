...
/// class BitgetFutures
///
BitgetFutures::BitgetFutures(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent /* = nullptr */)
...
void BitgetFutures::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void BitgetFutures::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
