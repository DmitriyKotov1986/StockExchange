...
/// class BybitFutures
///
BybitFutures::BybitFutures(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void BybitFutures::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void BybitFutures::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
