...
#include "StockExchange/bitgetkline.h"
...
/// class Bitget
///
Bitget::Bitget(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent /* = nullptr */)
...
void Bitget::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Bitget::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
