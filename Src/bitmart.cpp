...
#include "StockExchange/bitmartkline.h"
...
/// class Bitmart
///
Bitmart::Bitmart(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent /* = nullptr */)
...
void Bitmart::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Bitmart::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
