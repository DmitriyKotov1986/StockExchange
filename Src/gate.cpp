...
/// class Gate
///
Gate::Gate(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject *parent)
...
void Gate::sendLogMsgHTTP(Common::MSG_CODE category, const QString &msg, quint64 id)
{
...
void Gate::sendLogMsgPool(Common::MSG_CODE category, const QString &msg)
{
