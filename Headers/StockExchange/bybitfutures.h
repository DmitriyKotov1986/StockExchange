...
public:
    BybitFutures(const StockExchange::StockExchangeConfig& config, const Common::ProxyList& proxyList, QObject* parent = nullptr);
    ~BybitFutures() override;
...
private:
    Q_DISABLE_COPY_MOVE(BybitFutures);
