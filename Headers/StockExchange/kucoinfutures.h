...
public:
    KucoinFutures(const StockExchange::StockExchangeConfig& config, const Common::HTTPSSLQuery::ProxyList& proxyList, QObject* parent = nullptr);
    ~KucoinFutures();
...
private:
    Q_DISABLE_COPY_MOVE(KucoinFutures);
