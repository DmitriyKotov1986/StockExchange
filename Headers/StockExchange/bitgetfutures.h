...
public:
    BitgetFutures(const StockExchange::StockExchangeConfig& config, const Common::HTTPSSLQuery::ProxyList& proxyList, QObject* parent = nullptr);
    ~BitgetFutures();
...
private:
    Q_DISABLE_COPY_MOVE(BitgetFutures);
