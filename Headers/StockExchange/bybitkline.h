...
public:
    BybitKLine(const TradingCatCommon::KLineID& id, const QDateTime& lastClose, QObject* parent = nullptr);
    ~BybitKLine() override = default;
...
private:
    BybitKLine() = delete;
    Q_DISABLE_COPY_MOVE(BybitKLine);
