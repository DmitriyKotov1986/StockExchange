...
public:
    BitmartKLine(const TradingCatCommon::KLineID& id, const QDateTime& lastClose, QObject* parent = nullptr);
    ~BitmartKLine() override = default;
...
private:
    BitmartKLine() = delete;
    Q_DISABLE_COPY_MOVE(BitmartKLine);
