...
public:
    BingxKLine(const TradingCatCommon::KLineID& id, const QDateTime& lastClose, QObject* parent = nullptr);
    ~BingxKLine() override = default;
...
private:
    BingxKLine() = delete;
    Q_DISABLE_COPY_MOVE(BingxKLine);
